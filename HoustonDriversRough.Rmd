...
knitr::opts_chunk$set(echo = T, eval = F, echo = F)
```
...
25% SD is the difference between speeding and not speeding; we need to randomly generate sigma in all cases.
...
model_string <- "model{
  ...
  shape ~ dnorm(96, 1 / 10^2)
  rate ~ dnorm(75, 1 / 10^2)
