...
| Prior | Likelihood | Posterior CredI| Posterior Predictive I|
|-------|------------|----------------| jkl|
|mu ~ N($\bar{x}$, s*)|x ~ N(mu, s)| asdf| JKL|
|mu ~ N($\bar{x}$*, s*)|x ~ N(mu, s)| asdf| jkl|
|mu ~ N(0, 50)| x ~ N(mu, s)|asdf| jkl|
|$\alpha$ ~ N(96, 4), $\beta$ ~ N(75, 11)| x ~ Gamma($\alpha$, $\beta$)|asdf| jlk|
